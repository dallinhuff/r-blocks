...
export const features: Section<Feature> = {
  ...
  content: [
    ...
    },
    {
      ...
      description: `Our stay-in-place polyurethane molds have vastly better sound dampening.
    ...
    },
    {
      ...
      description: `R-Blocks' density and rigidity produce straighter walls (no bows or bulging).
                    They also do not require a covering, saving time and money as
                    foundations with R-Blocks can remain exposed during installation.`,
    },
    {
