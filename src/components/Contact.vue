        ...
        <div class="space-y-14">
          ...
          <div class="flex gap-x-5">
            ...
            <div class="grow">
              ...
              <a class="mt-1 text-neutral-400 text-sm" href="mailto:info@thermalblocksusa.com" target="_blank">
                info@thermalblocksusa.com
              </a>
            </div>
          </div>
          <!-- End Item -->
          ...
          <div class="flex gap-x-5">
            ...
            <div class="grow">
              ...
              <a href="tel:5039497698" class="mt-1 text-neutral-400">(503) 949-7698</a>
            </div>
          </div>
          <!-- End Item -->
        </div>
